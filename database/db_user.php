...
<?php
            ...
            if(isset($_POST["submit"])){
                ...
                if(empty($_POST["user_type"])){
                    $err["user_type"]="User Type is required";
                }
                else{
                ...
                if(empty($_POST["user_password"])){
                    ...
                    $price=htmlspecialchars($_POST["user_password"]);
                }
                if(empty($err)){
                    $query="insert into mobiles(mobile_name,mobile_description,quantity,price) values(?,?,?,?)";
                    $stmt=mysqli_prepare($dbc,$query);
                    mysqli_stmt_bind_param($stmt,"ssss",$name,$desc,$quantity,$price);
                    ...
                    if($res){
                        ...
                        $err["sql_err"]="Couldn't save data".mysqli_error($dbc);
                    }
                }
